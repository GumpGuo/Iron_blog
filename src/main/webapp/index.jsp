        ...
        <article class="blog-main">
            ...
            <div class="am-g blog-content">
                <div class="am-u-lg-12">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/blog/archive/1">博客</a></li>
                        <li><a href="${pageContext.request.contextPath}/blog/archive/1?typeId=1">分类1</a></li>
                    </ul>
                </div>
            </div>
        </article>
...
<%--<a href="${pageContext.request.contextPath}/blog/archive/1">博客</a>--%>
<%--<a href="${pageContext.request.contextPath}/blog/archive/1?typeId=1">分类1</a>--%>
